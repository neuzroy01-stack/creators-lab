// States & Union Territories of India with districts.
// Source: Census of India district listings. Used for cascading dropdowns.
...
export const INDIAN_STATES: StateData[] = [
  {
    name: "Andhra Pradesh",
    districts: [
      "Alluri Sitharama Raju", "Anantapur", "Anakapalli", "Bapatla", "Chittoor",
      "East Godavari", "Eluru", "Guntur", "Kakinada", "Konaseema", "Krishna",
      "Kurnool", "Nandyal", "NTR", "Palnadu", "Prakasam", "Sri Potti Sriramulu Nellore",
  ...
  },
  {
    ...
    districts: [
      ...
      "Kra Daadi", "Lower Subansiri", "Upper Subansiri", "Kamle", "Siang",
      "Upper Siang", "West Siang", "Lower Siang", "Lepa Rada", "Basar",
      "Pakke Kessang", "East Siang", "Dibang Valley", "Lower Dibang Valley",
  ...
  },
  {
    ...
    districts: [
      ...
      "Lakhimpur", "Majuli", "Morigaon", "Nagaon", "Nalbari", "Dima Hasao",
      "Sivasagar", "South Salmara Mankachar", "Sonitpur", "Tinsukia",
  ...
  },
  {
    ...
    districts: [
      ...
      "Lakhisarai", "Lalitpur", "Madhepura", "Madhubani", "Munger", "Muzaffarpur",
  ...
  },
  {
    name: "Nagaland",
    districts: [
      "Chumoukeda", "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung",
  ...
  },
  {
    name: "Tamil Nadu",
    districts: [
      "Chengalpattu", "Chennai", "Coimbatore", "Cuddalore", "Dharmapuri",
  ...
  },
  {
    ...
    districts: [
      ...
      "Ghaziabad", "Ghazipur", "Gonda", "Hamirpur", "Hapur", "Hardoi", "Hathras",
  ...
  },
  {
    ...
    districts: [
      ...
      "Darjeeling", "Hooghly", "Howrah", "Jhargram", "Kalimpong", "Kolkata",
